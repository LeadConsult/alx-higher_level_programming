...
class TestBase_to_json_string(unittest.TestCase):
    """Unit tests for the Base class's to json string method."""
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittests to test the Base class's save to file method."""
...
class TestBase_from_json_string(unittest.TestCase):
    """Unit tests for the Base class's from json string method."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Unittests to test the Base class's save to file csv method."""
